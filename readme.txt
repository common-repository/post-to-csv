...
* Choose exported post status:
	...
	* Inherit
	* Private
* Set default post sorting order by:
	* Title
	* Date
	* Author
...
= What post types does the plugin work with? =

It works with all post types that are present in the database in the posts table.
...
= V1.4.2 - 19.08.2024 =
* Update : We updated functionality for wordpress 6.6.1.
* Update : BWS plugins section is updated.
* Bugfix : Posts/comments export issues has been fixed.

= V1.4.1 - 17.08.2023 =
* Update : We updated functionality for wordpress 6.3.
* Update : BWS plugins section is updated.
* Bugfix : Vulnerability security issues has been fixed.

= V1.4.0 - 05.10.2022 =
* Bugfix : CSV fomulas while post exporting has been fixed.
...
= V1.0 =
The ability to select the fields to be sorted and the order direction were added.
